...
<!-- Sidebar -->
<aside id="admin-sidebar" class="w-64 bg-slate-800 shadow-xl flex-shrink-0 fixed left-0 top-0 h-screen transform transition-transform duration-300 z-50 lg:transform-none lg:fixed lg:z-40 -translate-x-full lg:translate-x-0 flex flex-col lg:overflow-y-auto">
    <!-- Brand -->
